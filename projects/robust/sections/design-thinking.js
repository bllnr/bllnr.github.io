        ...
        .map((card, index) => {
            const listItemsHtml = card.items
                ...
                <li class="leading-relaxed text-slate-700">
                    <strong class="text-zinc-900 font-semibold">${parts[0]}:</strong>${parts[1]}
                </li>`;
                    }
            ...
            return `
                <div class="rounded-2xl group border-2 border-zinc-200 transition-all duration-300 hover:shadow-2xl hover:shadow-zinc-500/20 hover:-translate-y-1 cursor-pointer  hover:border-zinc-400 text-left">
                    <div class="p-8">
